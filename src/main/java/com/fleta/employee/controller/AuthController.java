...
import com.fleta.employee.dto.auth.request.AuthCreateRequestDto;
import com.fleta.employee.dto.auth.response.AuthCreateResponseDto;
...
public class AuthController {
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "사원 등록 성공", content = @Content(schema = @Schema(implementation = AuthCreateResponseDto.class))),
    ...
    @Operation(summary = "등록", description = "사원 등록")
    @PostMapping("/create")
